    ...
    <div class="card-body">
        ...
        <div class="card">
            <div class="card-header bg-dark text-white">
                <h4 class="card-title text-primary">Add New Option</h4>
            </div>
        
            <form action="{{ route('dashboard.options.store') }}" method="POST" enctype="multipart/form-data" class="p-3">
                @csrf
                <div class="form-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="option" class="form-control" value="{{ old('option') }}" name="option">
                                @error("option")
