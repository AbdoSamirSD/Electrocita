<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
      ...
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{route('dashboard.languages.list')}}">
          <span class="menu-icon"><i class="mdi mdi-earth"></i></span>
          <span class="menu-title">Languages</span>
        </a>
      </li>
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{route('dashboard.categories.list')}}">
          <span class="menu-icon"><i class="fas fa-shopping-cart"></i></span>
          <span class="menu-title">Categories</span>
        </a>
      </li>
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{route('dashboard.subcategories.list')}}">
          <span class="menu-icon"><i class="fas fa-shopping-cart"></i></span>
          <span class="menu-title">SubCategories</span>
        </a>
      </li>
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{route('dashboard.brands.list')}}">
          <span class="menu-icon"><i class="fas fa-shopping-cart"></i></span>
          <span class="menu-title">Brands</span>
        </a>
      </li>
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{route('dashboard.vendors.list')}}">
          <span class="menu-icon"><i class="fas fa-store"></i></span>
          <span class="menu-title">Vendors</span>
        </a>
      </li>
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{route('dashboard.tags.list')}}">
          <span class="menu-icon"><i class="fas fa-store"></i></span>
          <span class="menu-title">Tags</span>
        </a>
      </li>
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{route('dashboard.products.list')}}">
          <span class="menu-icon"><i class="fas fa-store"></i></span>
          <span class="menu-title">Products</span>
        </a>
      </li>
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{route('dashboard.attributes.list')}}">
          <span class="menu-icon"><i class="fas fa-store"></i></span>
          <span class="menu-title">Attributes</span>
        </a>
      </li>
      <li class="nav-item menu-items">
        <a class="nav-link" href="{{route('dashboard.options.list')}}">
          <span class="menu-icon"><i class="fas fa-store"></i></span>
